...
function starting_theme_setup() {
	...
	register_nav_menus( array(
		...
		'footer' => esc_html__( 'Footer', 'starting-theme' ),
		'services' => esc_html__( 'Services', 'starting-theme' ),
	) );
...
function starting_theme_scripts() {
	...
	wp_enqueue_script( 'paroller-pack', get_template_directory_uri() . '/js/jquery.paroller.min.js', array(), '1.4.7', true );
	wp_enqueue_script( 'cookieconsent', get_template_directory_uri() . '/js/cookieconsent.min.js', array(), '3.1.0', true );
	wp_enqueue_script( 'swiper-js', get_template_directory_uri() . '/js/swiper-bundle.min.js', array(), '6.3.4', true );
	wp_enqueue_script( 'functions-js', get_template_directory_uri() . '/js/functions.js', array(), '0.1', true );
	wp_enqueue_script( 'main-js', get_template_directory_uri() . '/js/main.js', array(), '20201022', true );
	wp_enqueue_script( 'classie-js', get_template_directory_uri() . '/js/classie.js', array(), '20201022', true );
	wp_enqueue_script( 'hamburgers-js', get_template_directory_uri() . '/js/hamburgers.js', array(), true );
